...
const Tagline = styled.p`@media (min-width: 640px) {margin: auto 3.125vw;}`;
...
const Title = styled.h1`
  ...
  @media (min-width: 320px) {
    font-size: calc(
      41.888px + (109.664 - 41.888) * (100vw - 320px) / (640 - 320)
    );
  }
      ...
      <div>
        ...
        <Bar>
          <Subheader>
            ...
            <Tagline>
              Top voted stories across the web, summarized and updated every
              sixty seconds.
            </Tagline>
            <Medium>
          ...
          <Error
            black={black}
            display={!this.state.fetching && this.state.stories.length === 0}
          />
        </Bar>
        <Masonry
          options={{
        ...
        >
          ...
          />
          <Story fetching={this.state.fetching} {...this.state.stories[2]} />
          <Story fetching={this.state.fetching} {...this.state.stories[3]} />
          <Story fetching={this.state.fetching} {...this.state.stories[4]} />
          ...
          <Story fetching={this.state.fetching} {...this.state.stories[5]} />
          <Story fetching={this.state.fetching} {...this.state.stories[6]} />
          <Story
            fetching={this.state.fetching}
            thumbnail
            {...this.state.stories[7]}
          />
          <Story fetching={this.state.fetching} {...this.state.stories[8]} />
          <Story fetching={this.state.fetching} {...this.state.stories[9]} />
          <Story fetching={this.state.fetching} {...this.state.stories[10]} />
          {this.state.stories
            .slice(11)
            .map(story => (
              <Story fetching={this.state.fetching} key={story.id} {...story} />
            ))}
        </Masonry>
      </div>
    );
